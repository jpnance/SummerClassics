...
The runt uses [mkcert](https://github.com/FiloSottile/mkcert) to generate locally-trusted certificates. It creates `classix-key.pem` and `classix.pem` for `classics.coinflipper.local`.
